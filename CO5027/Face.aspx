...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="foundation">
        <img src="Images/foundation.png" height="200" width="200" alt="Hellow Flawless foundation image" />
    ...
    <div id="easy">
        <img src="Images/bigeasy.jpe" height="200" width="200" alt="Big Easy BB cream image" />
    ...
    <div id="Gorg">
        <img src="Images/gorg.jpg" height="200" width="200" alt="Cream foundation image" />
    ...
    <div id="hoola">
        <img src="Images/hoola.jpg" height="200" width="200" alt="Hoola bronze image" />
        <h3>Hoola</h3>
    ...
    <div id="fine">
        <img src="Images/fine.jpg" height="200" width="200" alt="Cheek contour blusher image" />
    ...
    <div id="watts">
        <img src="Images/watts.jpg" height="200" width="200" alt="Watts-Up cheek highlighter image" />
        <h3>Watt's Up!</h3>
