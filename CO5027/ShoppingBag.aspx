...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>Ensure you have logged in or signed up before proceding futher, to enable your address is displayed for shipping location.</p>
    
    <asp:Label ID="lblQuantityWanted" runat="server" Text="Quantity" AssociatedControlID="dListQuantity">

    </asp:Label>
    <asp:DropDownList ID="dListQuantity" runat="server">
        <asp:ListItem>1</asp:ListItem>
          <asp:ListItem>2</asp:ListItem>
         <asp:ListItem>3</asp:ListItem>
    </asp:DropDownList>
     <p>posting will be £2.80</p>
    <asp:Button ID="btnFinalPurchase" runat="server" Text="Buy" OnClick="btnFinalPurchase_Click" />
